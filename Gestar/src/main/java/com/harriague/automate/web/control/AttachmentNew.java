...
public class AttachmentNew extends Control implements Attachment{
    ...
    private String closeButtomPath = "button[value='Cerrar']";
    ...
    public AttachmentNew(String name, String title) {
        super(name, title);
    }


    public AttachmentNew(String name) {
        super(name);
        setCssSelector();
    }
    ...
    public By getAddButton() {
        return null;//addButton;
    }

    @Override
    public By getDeleteButton() {
        return null;//deleteButton;
    }
    ...
    public By getAttachButton() {
        return null;//attachButton;
    }

    @Override
    public By getAttatchName() {
        return null;//attatchName;
    }

    @Override
    public void setCssSelector() {
        super.setCssSelectorById("div.cls-" + getName() + " span.input-group-addon");
    }
}